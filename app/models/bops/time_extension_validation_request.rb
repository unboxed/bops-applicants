...
module Bops
  class TimeExtensionValidationRequest
    ...
    class << self
      def find(id, planning_application_id, change_access_id)
        Apis::Bops::Client.get_time_extension_validation_request(id, planning_application_id, change_access_id)
      end

      def approve(id, planning_application_id, change_access_id)
        Apis::Bops::Client.patch_approved_time_extension(id, planning_application_id, change_access_id)
      end
