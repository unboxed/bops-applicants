...
module Bops
  class PreCommencementConditionValidationRequest
    ...
    class << self
      def find(id, planning_application_id, change_access_id)
        Apis::Bops::Client.get_pre_commencement_condition_validation_request(id, planning_application_id,
          change_access_id)
      end

      def approve(id, planning_application_id, change_access_id)
        Apis::Bops::Client.patch_approved_pre_commencement_condition_validation_request(id, planning_application_id, change_access_id)
      end

      def reject(id, planning_application_id, change_access_id, rejection_reason)
        Apis::Bops::Client.patch_rejected_pre_commencement_condition_validation_request(id, planning_application_id, change_access_id,
          rejection_reason)
      end
    end
