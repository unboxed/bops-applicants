...
RSpec.describe Bops::PreCommencementConditionValidationRequest, type: :model do
  describe "validations" do
    let(:pre_commencement_condition_validation_request) { described_class.new }
    ...
    describe "#rejection_reason" do
      it "validates presence when not approved" do
        ...
        }.to ["Fill in why you disagree with the proposed pre-commencement condition."]
      end
    end
  end
