...
RSpec.describe "Document change requests", type: :system do
  ...
  it "allows the user to update a document change request" do
    ...
    change_request_patch_request = stub_request(:patch, "https://default.local.abscond.org/api/v1/planning_applications/28/replacement_document_validation_requests/8?change_access_id=345443543")
