...
RSpec.describe "Change requests", type: :system do
  ...
  it "allows the user to accept a change request" do
    ...
    change_request_patch_request = stub_request(:patch, "http://default.lvh.me:3000/api/v1/planning_applications/28/description_change_requests/18?change_access_id=345443543")
    .with(
  ...
  it "allows the user to reject a change request" do
    ...
    change_request_patch_request = stub_request(:patch, "http://default.lvh.me:3000/api/v1/planning_applications/28/description_change_requests/22?change_access_id=345443543")
    .with(
