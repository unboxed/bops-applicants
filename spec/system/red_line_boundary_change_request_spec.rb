...
RSpec.describe "Description change requests", type: :system do
  ...
  it "allows the user to accept a change request" do
    ...
    change_request_patch_request = stub_request(:patch, "https://default.lvh.me:3000/api/v1/planning_applications/28/red_line_boundary_change_requests/10?change_access_id=345443543")
                                       .with(
